    ...
    try {
        ...
        aree.forEach(function(area) {
            ...
            const ventuskyUrl =
                ...
                centroArea.lat.toFixed(4) +
                ";" +
                centroArea.lon.toFixed(4) +
                ";9&l=temperature-2m";
            ...
            polygon.bindPopup(
                ...
                "'>" +
                    ...
                    "'>" +
                        ...
                        "<div><b>Municipalità:</b><br>" + municipalita + "</div>" +
                        "<div><b>Prefettura:</b><br>" + prefettura + "</div>" +
                        "<div><b>Quote:</b><br>Min: " + quotaMin + " ft<br>Max: " + quotaMax + " ft</div>" +
...
window.addEventListener("load", function() {
    ...
    document.getElementById(
        ...
        salvaModificaProgetto();

    };

    document.getElementById(
        "delete-selected-project-btn"
    ).onclick = function() {

        eliminaProgettoGestione();
...
function calcolaCentroArea(punti) {
    ...
    return {
        lat: sommaLat / punti.length,
        lon: sommaLon / punti.length
    };
}

function apriGestioneProgetti() {
...
function caricaDatiProgettoGestione() {
...
function salvaModificaProgetto() {
    ...
    if (!nuovoNome) {
        alert("Inserisci il nome progetto.");
        return;
    }
...
function eliminaProgettoGestione() {
...
function avviaSplashOrbit() {
    ...
    if (!splash || !testo || !barra) {
        return;
    }

    const fasi = [
        {
            testo: "Inizializzazione sistema...",
            percentuale: 25
        },
        {
        ...
        {
            testo: "Preparazione interfaccia...",
            percentuale: 80
        },
        {
            testo: "Avvio ORBIT MAP WEB...",
            percentuale: 100
        }
    ];
    ...
    function aggiorna() {
        ...
        testo.innerText = fasi[indice].testo;
        barra.style.width = fasi[indice].percentuale + "%";

        indice++;

        setTimeout(aggiorna, 550);
    }
