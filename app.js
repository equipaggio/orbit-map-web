...
function applicaFiltroMunicipalita(nome) {
    ...
    areeCaricate.forEach(
        function(area) {

            if (
                !nome
                ||
                area.municipalita === nome
            ) {
...
function disattivaFiltri() {
    ...
    sitiCaricati.forEach(function(sito) {
        if (sito.marker && !map.hasLayer(sito.marker)) {
...
function applicaFiltroSiti(anno) {

    filtroSitiAttivo = anno;
